$(document).ready(function() {
    ...
    var openOffer = (function(){
        ...
        offerMenu.on('click',function(e){
           if (e.currentTarget.id ==='a-assemble') {
               openAssembleDescription();
           }
           if (e.currentTarget.id === 'a-renovate'){
               openRenovateDescription();
           }
           if (e.currentTarget.id ==='a-terrace'){
               openTerraceDescription();
           }
           if (e.currentTarget.id === 'a-sell'){
               openSellDescription();
           }
        });
